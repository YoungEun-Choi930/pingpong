...
public class BracketsColomnFragment extends Fragment {
    ...
    private void initViews() {
        gameNum = (TextView) getView().findViewById(R.id.game_number);
    ...
    private void getExtras() {
        if (getArguments() != null) {
            ...
            if(list.size() == 1) gameNum.setText("결승전");
            else if(list.size() == 2) gameNum.setText("준결승전");
            else gameNum.setText(list.size()*2+"강전");
